...
供货账户0：fanbit
'''
account_name.append('fanbit')
sell_keys.append('9591f1db7dd340f1830a5d2344c8d8d2')
sell_secrets.append('57ac5705d1ba40dda3f171cc25dcf289')
f1 = Fcoin()
...
供货账户1：bitbcn
'''
account_name.append('bitbcn')
sell_keys.append('35d34470f260458097db66400cef0fe2')
sell_secrets.append('44868988069f43dc91ff4e1b08b46eee')
f2 = Fcoin()
...
供货账户2：ffanbit
'''
account_name.append('fatbtc4')
sell_keys.append('9591f1db7dd340f1830a5d2344c8d8d2')
sell_secrets.append('57ac5705d1ba40dda3f171cc25dcf289')
f3 = Fcoin()
sell_accounts.append(f3)
sell_accounts[2].auth(sell_keys[2],sell_secrets[2])
...
进货账户0：fanbit
'''
account_name_buy.append('fanbit')
buy_keys.append('9591f1db7dd340f1830a5d2344c8d8d2')
buy_secrets.append('57ac5705d1ba40dda3f171cc25dcf289')
bf1 = Fcoin()
...
进货账户1：bitbcn
'''
account_name_buy.append('bitbcn')
buy_keys.append('35d34470f260458097db66400cef0fe2')
buy_secrets.append('44868988069f43dc91ff4e1b08b46eee')
bf2 = Fcoin()
...
def transport():
    def query_avg():
        try:
            candles = sell_accounts[0].get_candle('M1',symbol,limit=20)
            if candles['status'] != 0:
...
#       判断是否区间过大(大于40)，若过大则看是否被拉高或砸低，被拉高则在高位刷单，被拉低则在低位刷单
        if float(depth['asks'][0]) - float(depth['bids'][0]) > 0.00000040:
            if query_avg() < (float(depth['bids'][0])+float(depth['asks'][0]))/2:
                price = round(random.uniform(float(depth['asks'][0])-0.00000020,float(depth['asks'][0])-0.00000001),8)
            else:
                price = round(random.uniform(float(depth['bids'][0])+0.00000001,float(depth['bids'][0])+0.00000020),8)
